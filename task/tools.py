...
_TASK_UPDATE_SCHEMA = {
    "name": "TaskUpdate",
    "description": (
        "Update an existing task. Can change subject, description, status, owner, and metadata. "
...
_TASK_LIST_SCHEMA = {
    "name": "TaskList",
    "description": (
        "List all tasks. Returns id, subject, status, and owner. "
